                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                        <a href="bookingstatus.php?id=<?php echo $data['id']; ?>&status=Accept"><i class="fa fa-check text-success"></i></a>
                                        <a href="bookingstatus.php?id=<?php echo $data['id']; ?>&status=Reject"><i class="fa fa-times text-danger"></i></a>
