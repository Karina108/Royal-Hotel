...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=777775484ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotelbooking&table=rooms">`hotelbooking`.`rooms`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotelbooking&table=hotel">`hotelbooking`.`hotel`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotelbooking&table=enquiry">`hotelbooking`.`enquiry`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotelbooking&table=booking">`hotelbooking`.`booking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotelbooking&table=admin_login">`hotelbooking`.`admin_login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=formsubmit&table=gallery">`formsubmit`.`gallery`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=formsubmit&table=admin_login">`formsubmit`.`admin_login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotelbooking&table=user">`hotelbooking`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotelbooking&table=user_login">`hotelbooking`.`user_login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotelbooking&table=user_registration">`hotelbooking`.`user_registration`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6e4c584d30395d66447c606b29467339">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="hotelbooking" targettable="rooms">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `rooms`  
ORDER BY `rooms`.`hotel` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="hotelbooking" targettable="rooms">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `rooms`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="hotelbooking" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="hotelbooking" targettable="admin_login">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin_login`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="hotelbooking" targettable="admin_login">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin_login`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="hotelbooking" targettable="booking">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `booking`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="hotelbooking" targettable="enquiry">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `enquiry`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="hotelbooking" targettable="hotel">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `hotel`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="hotelbooking" targettable="rooms">
                            <div class="action_content">
